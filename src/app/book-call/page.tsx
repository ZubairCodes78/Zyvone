    ...
    <>
          ...
          <div ref={useReveal()} className="max-w-[720px]">
            ...
            <div className="space-y-6">
              <div className="flex gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-sans font-semibold text-[16px] md:text-[18px] text-white mb-1">We review your situation</h3>
                  <p className="font-sans text-[15px] md:text-[16px] text-white/50 leading-[1.7]">
              ...
              <div className="flex gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-sans font-semibold text-[16px] md:text-[18px] text-white mb-1">We identify opportunities</h3>
                  <p className="font-sans text-[15px] md:text-[16px] text-white/50 leading-[1.7]">
              ...
              <div className="flex gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-sans font-semibold text-[16px] md:text-[18px] text-white mb-1">We give you a clear path</h3>
                  <p className="font-sans text-[15px] md:text-[16px] text-white/50 leading-[1.7]">
      ...
      <section className="bg-primary-brand py-20 md:py-24 px-6 text-center">
        <div className="max-w-[1360px] mx-auto">
          ...
          <p ref={useReveal(300)} className="font-sans text-[12px] md:text-[13px] text-text-muted mt-6">
      ...
      <section className="bg-secondary-bg py-20 md:py-28 px-6">
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="space-y-6">
            <div ref={useReveal(100)} className="border-b border-line-dark pb-4 md:pb-6">
              <h3 className="font-sans font-semibold text-[16px] md:text-[18px] text-text-primary mb-2">Is this a sales call?</h3>
              <p className="font-sans text-[15px] md:text-[16px] text-text-secondary leading-[1.7]">
            ...
            <div ref={useReveal(150)} className="border-b border-line-light pb-4 md:pb-6">
              <h3 className="font-sans font-semibold text-[16px] md:text-[18px] text-text-primary mb-2">How long does the call take?</h3>
              <p className="font-sans text-[15px] md:text-[16px] text-text-secondary leading-[1.7]">
                15 minutes. We respect your time. We'll cover what matters and end on time.
              </p>
            </div>

            <div ref={useReveal(200)} className="border-b border-line-light pb-4 md:pb-6">
              <h3 className="font-sans font-semibold text-[16px] md:text-[18px] text-text-primary mb-2">Who should book this call?</h3>
              <p className="font-sans text-[15px] md:text-[16px] text-text-secondary leading-[1.7]">
            ...
            <div ref={useReveal(250)} className="border-b border-line-light pb-4 md:pb-6">
              <h3 className="font-sans font-semibold text-[16px] md:text-[18px] text-text-primary mb-2">What if we're not a fit?</h3>
              <p className="font-sans text-[15px] md:text-[16px] text-text-secondary leading-[1.7]">
            ...
            <div ref={useReveal(300)} className="border-b border-line-dark pb-4 md:pb-6">
              <h3 className="font-sans font-semibold text-[16px] md:text-[18px] text-text-primary mb-2">Do I need to prepare anything?</h3>
              <p className="font-sans text-[15px] md:text-[16px] text-text-secondary leading-[1.7]">
